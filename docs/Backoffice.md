...
At the right top of the header, you can select the project you want to view. Next, the information shown on the dashboard is filtered as well as all the options offered in the left menu. In addition, the header provides a user menu where you can access user-specific functionalities, and a configuration menu that allows you to customize settings such as dark mode or font size.
