...
6. Once you are satisfied with the response, save the first version of your Chat assistant. Later on, you can come back to the [RAG Assistants section](RAGAssistantsSection.md) to tweak the configuration.
